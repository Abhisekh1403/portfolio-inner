...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            ...
            projects: ["Abhishek-personal-portfolio", "synonyms-list-react", "economist.com-unlocked", "Improve-Codeforces", "flutter-banking-app", "Meditech-Healthcare", "CPU-Scheduling-APP-React-Native"],
        ...
        return (
            <React.Fragment key={id}>
                <div className="flex w-full h-5">
                    <div className="flex">
                        <div className=" text-ubt-green">Abhishek@Dell</div>
    ...
    handleCommands = (command, rowId) => {
        ...
        switch (main) {
            ...
            case "pwd":
                ...
                result = str.replace("~", "/home/Abhishek")
                break;
            case "code":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("vscode");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-Abhishek, todoist, trash, settings, sendmsg]";
                }
                break;
            case "echo":
            ...
            case "about-Abhishek":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("about-Abhishek");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands: [ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-Abhishek, todoist, trash, settings, sendmsg ]";
                }
                break;
